...
{
    public static async Task SeedAsync(InventarioDbContext context, ILogger logger, Dictionary<string, Guid>? sucursalesMap = null)
    {
    ...
    private static async Task SeedProductosAsync(InventarioDbContext context, ILogger logger)
    {
    ...
    private static async Task SeedAlmacenesAsync(InventarioDbContext context, Dictionary<string, Guid> sucursalesMap, ILogger logger)
    {
    ...
    private static async Task SeedStockYSeriadosAsync(InventarioDbContext context, ILogger logger)
    {
